        ...
        <>
            ...
            <div className="bg-gray-900 text-white pt-24 pb-16" data-aos="fade-right">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl md:text-4xl font-bold mb-6">Layanan Notaris dan PPAT di Cirebon, Jawa Barat</h1>
                    <p className="text-gray-300 mb-8">Kantor Notaris dan PPAT Harsoyo menyediakan berbagai layanan hukum profesional untuk masyarakat Cirebon dan Jawa Barat.</p>
                    ...
                    <div className="mt-12">
                        <h2 className="text-2xl font-semibold mb-6">Mengapa Memilih Notaris dan PPAT Jaenuddin Umar di Cirebon?</h2>
                        <div className="grid md:grid-cols-3 gap-6">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-gray-300 text-sm">Sebagai notaris dan ppat cirebon terpercaya dengan pengalaman</p>
                            </div>
                            <div className="text-center">
                                <div className="bg-gold-500 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                                ...
                                <p className="text-gray-300 text-sm">Kantor notaris dan ppat yang mudah diakses di Cirebon, Jawa Barat</p>
                            </div>
                        </div>
                    </div>
                </div>
